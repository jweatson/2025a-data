...
print("name, rc, vel, diskstot, Zany, ZAlsig, ZAlsol, ZFelow, ZFehi, ZtotalAl, ZtotalFe")

for rc in rcs:
  for mass in masses:
    for vel in vels:
      name = "set-a-rc-{}-inv-{}".format(rc,vel)

      dd = d

      dd = dd[dd.rc == rc]
      dd = dd[dd.interloper_mass == mass]
      ...
      for sim in sims:
        ...
        dddsolany.append(len(dddsolal[dddsolal.yield_ratio_decay > 0.0]) / len(dddsolal))
